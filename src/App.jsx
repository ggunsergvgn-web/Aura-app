  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 28px", background: "radial-gradient(ellipse at 50% 0%, #3b0764 0%, #1a0533 45%, #0d0018 100%)" }}>
      ...
      <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <button onClick={handle} disabled={loading} style={{ background: "linear-gradient(135deg, #c084fc, #7c3aed)", border: "none", borderRadius: 16, padding: "16px", color: "#fff", fontSize: 16, fontWeight: 800, cursor: "pointer", marginTop: 4, fontFamily: "inherit", boxShadow: "0 8px 30px rgba(168,85,247,0.4)" }}>
      ...
      {selectedUser ? (
        <>
            ...
            {messages.map(msg => {
              ...
              return (
                <div key={msg.id} style={{ display: "flex", justifyContent: isMe ? "flex-end" : "flex-start", alignItems: "flex-end", gap: 8 }}>
                  ...
                  <div style={{ maxWidth: "72%", padding: "10px 14px", borderRadius: isMe ? "18px 18px 4px 18px" : "18px 18px 18px 4px", background: isMe ? "linear-gradient(135deg, #a855f7, #7c3aed)" : "rgba(255,255,255,0.07)", border: isMe ? "none" : "1px solid rgba(168,85,247,0.15)", color: "#fff", fontSize: 14, lineHeight: 1.5, boxShadow: isMe ? "0 4px 20px rgba(168,85,247,0.3)" : "none" }}>
                    {msg.content}
          ...
          <div style={{ padding: "10px 12px 36px", display: "flex", gap: 8, alignItems: "center", background: "rgba(20,0,40,0.95)", backdropFilter: "blur(20px)", borderTop: "1px solid rgba(168,85,247,0.1)" }}>
            <div style={{ flex: 1, background: "rgba(168,85,247,0.08)", borderRadius: 24, padding: "11px 16px", border: "1px solid rgba(168,85,247,0.2)" }}>
        ...
        <div style={{ margin: "12px 16px", borderRadius: 20, background: "rgba(168,85,247,0.07)", border: "1px solid rgba(168,85,247,0.2)", padding: "14px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10 }}>
            <div style={{ display: "flex", gap: 8 }}>
              <button onClick={() => fileRef.current.click()} style={{ background: "rgba(168,85,247,0.15)", border: "1px solid rgba(168,85,247,0.3)", borderRadius: 20, padding: "6px 14px", color: "#c084fc", fontSize: 12, cursor: "pointer", fontFamily: "inherit" }}>📷 Medya</button>
...
export default function App() {
  ...
  if (loading) return (
    <div style={{ background: "radial-gradient(ellipse at 50% 0%, #3b0764 0%, #0d0018 100%)", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 16 }}>
      <div style={{ width: 70, height: 70, borderRadius: 22, background: "linear-gradient(135deg, #c084fc, #7c3aed)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 32, boxShadow: "0 20px 60px rgba(168,85,247,0.5)" }}>🌀</div>
